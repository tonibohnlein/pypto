...
class TestAutoTileMatmulL0MNTiling:
    ...
    def test_dbc2_ptoas_co_lives_two_l0c_accumulators(self):
        ...
        **allocation**, which is the property, rather than on statement order.
        ...
        # and keeps two co-live accumulators; the explicit legacy PyPTO planner stays dbC=1
        ...
        assert len(pypto_accs) == 1, f"dbC=1 (explicit PyPTO) must use one L0C buffer, got: {pypto_accs}"
