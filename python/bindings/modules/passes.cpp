...
void BindPass(nb::module_& m) {
  ...
  nb::class_<utils::L0TileConfig>(l0_tile, "L0TileConfig",
      ...
      .def_rw("load_a_issue_cycles", &utils::L0TileConfig::load_a_issue_cycles)
      .def_rw("load_b_issue_cycles", &utils::L0TileConfig::load_b_issue_cycles)
      ...
      .def_rw("mad_acc_dependency_cycles", &utils::L0TileConfig::mad_acc_dependency_cycles)
