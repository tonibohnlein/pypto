...
void BindPass(nb::module_& m) {
  ...
  nb::class_<utils::L0TileResult>(l0_tile, "L0TileResult",
      ...
      .def_ro("load_cycles", &utils::L0TileResult::load_cycles)
      .def_ro("mad_cycles", &utils::L0TileResult::mad_cycles)
      .def_ro("drain_cycles", &utils::L0TileResult::drain_cycles)
      .def_ro("hidden_drain_cycles", &utils::L0TileResult::hidden_drain_cycles)
      .def_ro("single_buffer_c_cost_cycles", &utils::L0TileResult::single_buffer_c_cost_cycles)
