...
| `dsa-rp-kv-gumbel-legal-ablations-2bdc441b0-final.tar.gz` | five relation families, address controls, 6,400 samples | Gumbel `(2,39)` was causal but beneficial: adding overlap removed one barrier and improved latency by 2.1-2.35%. `(38,42)` cost about 1.9%, `(3,38)` about 0.4%, and `(38,79)` was null. KV `(8,22)` was not causal; all translation controls were null. |
