...
| 35 | [LegalizeWideGmToMatLoads](35-legalize_wide_gm_to_mat_loads.md) | 对超出目标 Mat-load 字段的 GM 行跨度进行指针重定位 |
...
| 53 | [LegalizeTileCastFragments](53-legalize_tile_cast_fragments.md) | 在物理布局确定后，将后端 cast 宽度限制物化为保留父行跨度的分片视图 |
