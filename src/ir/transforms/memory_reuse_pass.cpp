...
FunctionPtr TransformMaterializeSemanticAliases(const FunctionPtr& func) {
  ...
  // Explicit-address DSA planners must therefore run the remaining correctness
  // normalizations from MemoryReuse Steps 4 through 4.5 in the same order. They
  // are not optimizations: when a
