...
#ifndef PYPTO_IR_TRANSFORMS_DSA_RESEARCH_MEMREF_DSA_ADAPTER_H_
#define PYPTO_IR_TRANSFORMS_DSA_RESEARCH_MEMREF_DSA_ADAPTER_H_
...
#endif  // PYPTO_IR_TRANSFORMS_DSA_RESEARCH_MEMREF_DSA_ADAPTER_H_
